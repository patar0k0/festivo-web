...
export function FestivalHeroActionBar({ festivalId, icsHref, reminderAnchorId }: HeroProps) {
  ...
  const primaryClass =
    "inline-flex min-h-[48px] w-full flex-1 items-center justify-center gap-2 rounded-xl bg-[#ff4c1f] px-4 py-3 text-center text-sm font-semibold text-white shadow-[0_2px_0_rgba(0,0,0,0.08)] transition hover:bg-[#e6441a] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4c1f]/40 sm:min-w-[12rem]";
