...
ЗАГЛАВИЕ (title):
- title = ПЪЛНОТО официално име на фестивала + годината от заявката.
  Формула: [пълно официално название] + [година от user_query, ако е посочена].
  Примери:
    user_query „сурва 2026" → „Международен фестивал на маскарадните игри „Сурва" 2026"
    user_query „фолклорна плетеница 2026" → „Фолклорна плетеница 2026"
    user_query „коренът на традициите 2026" → „Фолклорен фестивал „Коренът на традициите" 2026"
- Пълното официално название се взема от текста (заглавия на статии, официален сайт, плакати) — не го измисляй.
- НЕ включвай: пореден номер на изданието, „юбилейно", „N-то издание", „международен" ако не е в официалното название.
  Лошо: „Юбилейното 32-ро издание на Международния фестивал на маскарадните игри „Сурва" 2026"
  Добро: „Международен фестивал на маскарадните игри „Сурва" 2026"
- Ако годината НЕ е в заявката — не я добавяй в заглавието.
- Ако в текста не е намерено по-дълго официално название — използвай формулировката от заявката + година.
