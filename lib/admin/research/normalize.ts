...
export function normalizeResearchResult(raw: ResearchFestivalResult): ResearchFestivalResult {
  const rawBestGuess = raw.best_guess ?? {
    ...
    description_short: raw.description_short ?? null,
    slug: raw.slug ?? null,
  ...
  const bestGuess = {
    ...
    description_short: normalizeText((rawBestGuess as { description_short?: unknown }).description_short),
    slug: normalizeText((rawBestGuess as { slug?: unknown }).slug),
    organizers,
    organizer,
  ...
  const normalized: ResearchFestivalResult = {
    ...
    description_short: bestGuess.description_short ?? null,
    slug: bestGuess.slug ?? null,
