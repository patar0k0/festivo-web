...
test("rejects domain that merely contains facebook.com as substring", () => {
  assert.equal("error" in normalizeFacebookEventUrl("https://fake-facebook.com/events/123"), true);
});
