...
ЗАГЛАВИЕ (title):
- title = КРАТКОТО СОБСТВЕНО ИМЕ на фестивала (напр. „Сурва", „Фолклорна плетеница", „Коренът на традициите").
- НЕ добавяй: годината, поредния номер/издание, типа на събитието, името на града, прилагателни описания — дори ако са в заявката или текста.
  Лоши примери: „Сурва 2026", „32-ри Сурва", „Международен фестивал Сурва", „Юбилейното издание на Сурва".
  Добри примери: „Сурва", „Фолклорна плетеница", „Коренът на традициите".
- Ако заявката съдържа кавички/ударение около собственото име — използвай тъкмо него: user_query „Коренът на традициите" 2026 → title = „Коренът на традициите".
- Годината НИКОГА не е в заглавието — тя се съхранява в start_date.
