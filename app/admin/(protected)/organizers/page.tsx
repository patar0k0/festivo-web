    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-black/[0.08] bg-white/85 p-5">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <Link href="/admin/organizers/new" className="inline-flex items-center rounded-lg bg-[#0c0e14] px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.12em] text-white hover:bg-black/80">
            + Добави
          </Link>
