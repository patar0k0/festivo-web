...
export async function runMockResearch(query: string): Promise<ResearchFestivalResult> {
  ...
  if (normalized.includes("сурва 2026") || normalized.includes("surva 2026")) {
    return {
      ...
      description:
        "Сурва е международен фестивал на маскарадните игри в Перник, включващ дефилета, конкурсна програма и съпътстващи културни събития.",
      ...
      sources: [
        ...
        {
          url: "https://visitpernik.com/",
          domain: "visitpernik.com",
      ...
      evidence: [
        {
          field: "title",
          value: "Международен фестивал на маскарадните игри „Сурва 2026“",
          source_url: "https://surva.org/",
        },
        {
          field: "dates",
          value: "2026-01-16 до 2026-01-25",
          source_url: "https://surva.org/",
        },
      ],
      metadata: {
