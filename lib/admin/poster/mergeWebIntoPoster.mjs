...
function fillConf(conf, webValue) {
  ...
  // Only fill a gap. A poster value that's merely flagged needs_review is still
  // poster-derived data and must not be clobbered by an unrelated web search hit.
  if (conf.value != null) return conf;
