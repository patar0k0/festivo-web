...
export type CanonicalFestivalFields = {
  title: string;
  slug: string | null;
  description: string | null;
  category: string | null;
...
export function canonicalFromPending(row: PendingFestivalRowLike): CanonicalFestivalFields {
  return {
    title: row.title,
...
export function canonicalFromFestival(row: FestivalRowLike): CanonicalFestivalFields {
  return {
    title: row.title,
    slug: normalizeText(row.slug),
    description: normalizeText(row.description),
...
export function pendingPatchFromCanonical(fields: CanonicalFestivalFields): Record<string, unknown> {
  return {
    title: fields.title,
    slug: fields.slug,
...
export function festivalPatchFromCanonical(fields: CanonicalFestivalFields): Record<string, unknown> {
  return {
    title: fields.title,
    slug: fields.slug,
    description: fields.description,
