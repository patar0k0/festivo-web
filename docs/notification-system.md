...
- **Следващи фази (извън scope):** preferences/unsubscribe за transactional канала, auth SMTP branding, digest/marketing, богати delivery dashboards.
